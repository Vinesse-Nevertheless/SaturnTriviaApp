...
![JavaScript](https://img.shields.io/badge/language-Javascript-purple)
...
3. NonCommercial.
   For the avoidance of doubt, NonCommercial means not primarily intended for or directed towards commercial advantage or monetary compensation. For purposes of this Public License, the exchange of the Licensed Material for other copyrighted material by digital file-sharing or similar means is NonCommercial provided there is no payment of monetary compensation in connection with the exchange.

4. Full Legal Code.
   The full text of the legal code for this license can be found at:
